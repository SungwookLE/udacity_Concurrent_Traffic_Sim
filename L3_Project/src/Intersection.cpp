...
{
    // (8.5) L3.1 DONE: This _mutex is added for mutual exclusion
    // of course, I can use just _mutex.lock() & unlock() mechanism, but unique_lock is more reliable for code stability
...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // (8/5) L3.3 DONE: it's for mutual exclusion while doing std::cout
